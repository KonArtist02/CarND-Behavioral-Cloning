...
X_train_zero, X_test_zero, y_train_zero, y_test_zero = train_test_split(img_paths_zero, steering_angles_zero, test_size=0.10, random_state=58)
X_train_left, X_test_left, y_train_left, y_test_left = train_test_split(img_paths_left, steering_angles_left, test_size=0.10, random_state=58)
X_train_right, X_test_right, y_train_right, y_test_right = train_test_split(img_paths_right, steering_angles_right, test_size=0.10, random_state=58)
...
tb_callback = TensorBoard(log_dir='./logs/01', write_graph=True, write_images=False) #histogram_freq=1


history = model.fit_generator(
		utils.myGenerator(y_train_zero, X_train_zero, y_train_right, \
						X_train_right, y_train_left, X_train_left, config.batch_size), \
		samples_per_epoch=5000, nb_epoch=1, callbacks=[tb_callback]\
